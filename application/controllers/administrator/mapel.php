...
class mapel extends CI_Controller
{
	public function __construct()
	{
		...
		$this->load->model('kelas_model'); // Mengubah 'Mapel_model' menjadi huruf kecil untuk sesuai dengan standar penamaan file model
	...
	public function index($tahun_ajaran = null)
	{
		...
		// die;
		$data['mapel'] = $this->Mapel_model->tampil_data($tahun_ajaran);
		$data['get_tahun_ajaran'] = $this->kelas_model->ambil_data_tahun_ajaran();
